...
declare const _default: {
    ...
    head: <R_3 extends never>(route: R_3, params: API[R_3]["params"], headers: RequestHeaders<"HEAD", R_3>, body: RequestBody<"HEAD", R_3>) => Promise<[ResponseHeaders<"HEAD", R_3>, ResponseBody<"HEAD", R_3>]>;
    patch: <R_4 extends never>(route: R_4, params: API[R_4]["params"], headers: RequestHeaders<"PATCH", R_4>, body: RequestBody<"PATCH", R_4>) => Promise<[ResponseHeaders<"PATCH", R_4>, ResponseBody<"PATCH", R_4>]>;
    delete: <R_5 extends never>(route: R_5, params: API[R_5]["params"], headers: RequestHeaders<"DELETE", R_5>, body: RequestBody<"DELETE", R_5>) => Promise<[ResponseHeaders<"DELETE", R_5>, ResponseBody<"DELETE", R_5>]>;
};
